...
def get_lambda_client(access_key, secret_key, session_token, region):
    """
...
def check_function_exists(function_name, access_key, secret_key, session_token, region):
    """
    ...
    """
    client = get_lambda_client(access_key, secret_key, session_token, region)
    try:
