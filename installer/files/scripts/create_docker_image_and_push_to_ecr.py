...
def build_and_push_docker_image(provider_json_file, ecr_repo, docker_file, docker_file_dir, log_file):
    ...
    aws_access_key, aws_secret_key, session_token, region_name = get_provider_credentials("aws", provider_json_file)
    auth_config_payload = get_docker_push_aws_auth_config(aws_access_key, aws_secret_key, session_token, region_name, log_file)
